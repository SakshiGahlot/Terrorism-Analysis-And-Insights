...
app = dash.Dash()
#Dash is a class and app is a global reference variable that points to the object
project_name = None
...
def load_data():
  ...
  #PREPARING DATA FOR DROPDOWNS  
    ...
    #for dropdown we need list of dictionary
...
def create_app_ui():
    # DROPDOWNS CREATED IN THIS FUNCTION
...
# Create a new callback for the dropdown change event
...
def update_app_ui(Tabs, month, date,region,country,state,city,attack,year,chart_year, chart_dp, search, subtabs2):
    #this is called whenever there is change in any inputs
    ...
    if Tabs == "Map":
        ...
        #update layout (to update the figure)                       
    ...
    return fig
#whatever this returns will update the output
...
def main():
    ...
    #designing UI
    #convert .png to .ico (16x16)
    #www.favicon.cc
    #favicon.ico store this in assets directory
